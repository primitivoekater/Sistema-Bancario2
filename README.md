# BackEnd - Desafio II : Sistema bancario:
...
Neste desafio,  utilizamos de todo o conhecimento do módulo 2 para a criação de uma  RESTful API onde é possivel cadastrar um usuario no banco e realizar transações como saque e deposito. nesse projeto  aprendemos  a criar rotas com controladores de segurança,  aprendemos a organizar o projeto com respectivas pastas e delimitadores de função e a importancia de um retorno auto-explicativo para o usuario leigo dependendo da situação  em que ele se encontra. mais detalhes se encontram no README interno da aplicação.
...
_Tornando público o desafio de BackEnd fornecidos pela Cubos Academy no curso de desenvolvimento de software._
